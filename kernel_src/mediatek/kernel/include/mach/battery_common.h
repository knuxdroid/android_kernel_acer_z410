...
#if defined(ACER_RUNIN_CHARGING)
#define BATTERY_TEST_STOP_CHARGING 5 //run in test 
#endif
#if defined(ACER_COMMON_DRV)
#define BATTERY_UNDER_NOTIFY_TEMP 6
#define BATTERY_OVER_NOTIFY_TEMP 7
#endif
...
typedef struct 
{
	...
	UINT32			ZCV;
	#if defined(ACER_COMMON_DRV)
    UINT32   		bat_temperature_status;  /*longxuewei modify for battery temprature check*/	
	#endif
