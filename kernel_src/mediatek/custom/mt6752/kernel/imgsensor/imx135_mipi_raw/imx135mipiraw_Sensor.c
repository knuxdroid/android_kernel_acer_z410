...
static imgsensor_info_struct imgsensor_info = { 
    ...
    .custom1 = {
        ...
        .linelength = 4572,             //record different mode's linelength
        .framelength = 1582,            //record different mode's framelength
        .startx = 2,                    //record different mode's startx of grabwindow
        .starty = 2,                    //record different mode's starty of grabwindow
	.grabwindow_width = 2088,//2096,		//record different mode's width of grabwindow
	.grabwindow_height = 1544,//1552,		//record different mode's height of grabwindow
        ...
        .startx = 2,                    //record different mode's startx of grabwindow
        .starty = 2,                    //record different mode's starty of grabwindow
		.grabwindow_width = 1044,//2096,		//record different mode's width of grabwindow
		.grabwindow_height = 772,//1552,		//record different mode's height of grabwindow
        /*   following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario   */
        .mipi_data_lp2hs_settle_dc = 85,
        /*   following for GetDefaultFramerateByScenario()  */
        .max_framerate = 300,   
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B, //pei_modify def R
    .mclk = 24,
...
{ 4208, 3120, 0000, 0000, 4208, 3120, 2104, 1560, 0000, 0000, 2104, 1560, 0007, 0007, 2088, 1544}, // Custom1 (defaultuse preview) 
 // { 4208, 3120, 0000, 0000, 4208, 3120, 1044, 772, 0000, 0000, 1044, 772, 0007, 0007, 1044, 772}, // Custom1 (defaultuse preview) 
...
static void sensor_init(void)
{
    ...
    */
    ...
    write_cmos_sensor(0x0101, 0x03);// pei_modify
...
if(imgsensor.update_sensor_otp_awb != 0) {}
	...
	#else
    write_cmos_sensor(0x0100,0x00);// STREAM STop
printk("tengdq binningmode_setting\n");
//Clock Setting
	write_cmos_sensor(0x011E,0x12);
	write_cmos_sensor(0x011F,0x00);
	write_cmos_sensor(0x0301,0x05);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
            ...
            spin_lock(&imgsensor_drv_lock);
            imgsensor.update_sensor_otp_awb = (BOOL)*feature_data_16;
            spin_unlock(&imgsensor_drv_lock);
