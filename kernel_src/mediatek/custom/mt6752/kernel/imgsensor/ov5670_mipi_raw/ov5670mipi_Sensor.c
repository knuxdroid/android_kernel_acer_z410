...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//pei , SENSOR_OUTPUT_FORMAT_RAW_R  ;sensor output first pixel color
...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR,				//pei_modify     mirrorflip information
...
#if defined(ACER_Z410)
static int RG_Ratio_Typical =0x11A; //0x10F; //271  
static int BG_Ratio_Typical =0x124; //0x103; //259	
#else 
...
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
	...
	write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0x7E) | 0x81));
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3820, 0x86); //pei_modify
	...
	write_cmos_sensor(0x450b, 0x20);//pei_modify def 0x00 
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x3820, 0x96);  // pei_modify							  
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	preview_setting();
//	set_mirror_flip(IMAGE_HV_MIRROR);//pei_add
	return ERROR_NONE;
}	/*	preview   */
