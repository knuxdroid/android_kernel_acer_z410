...
extern LCM_DRIVER otm1288a_hd720_dsi_cmd_lcm_drv;
extern LCM_DRIVER rm68171_dsi_vdo_lcm_drv;
extern LCM_DRIVER sim_rm68191_qhd_dsi_vdo_cmi_45;
extern LCM_DRIVER otm1284a_hd720_dsi_vdo_lcm_drv;
extern LCM_DRIVER sim_otm9605_qhd_dsi_vdo_hsd_45;
extern LCM_DRIVER tddi4291_jdi_hd_dsi_vdo_lcm_drv;
...
#if defined(OTM1288A_HD720_DSI_CMD)
	&otm1288a_hd720_dsi_cmd_lcm_drv,
#endif
#if defined(RM68171_FWVGA_DSI_VDO)
    &rm68171_dsi_vdo_lcm_drv,
#endif

#if defined(SIM_RM68191_QHD_DSI_VDO_CMI_45)
    &sim_rm68191_qhd_dsi_vdo_cmi_45,
#endif

#if defined(SIM_OTM9605_QHD_DSI_VDO_HSD_45)
    &sim_otm9605_qhd_dsi_vdo_hsd_45,
#endif

#if defined(OTM1284A_HD720_DSI_VDO)
	&otm1284a_hd720_dsi_vdo_lcm_drv,
#endif
#if defined(TDDI4291_JDI_HD_DSI_VDO)
	&tddi4291_jdi_hd_dsi_vdo_lcm_drv,
#endif
};
