...
UINT32 S5K3L2XX_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);//pei_e800s
...
//pei_e800
    ...
    {GC5004_SENSOR_ID, SENSOR_DRVNAME_GC5004_MIPI_RAW, GC5004_MIPI_RAW_SensorInit}, 
#endif
