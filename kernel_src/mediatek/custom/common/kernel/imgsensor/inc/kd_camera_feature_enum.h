...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
        ...
        SCENE_MODE_BARCODE,
        SCENE_MODE_BACKLIGHT,	//acer camera 3.2
        SCENE_MODE_BACKLIGHT_PORTRAIT,
        SCENE_MODE_NUM
    )
) SCENE_MODE_T;
...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
        ...
        AE_MODE_HDR,
        AE_MODE_BACKLIGHT,	//acer camera 3.2
        AE_MODE_BACKLIGHT_PORTRAIT,
        AE_MODE_TOTAL_NUM
    )
) AE_MODE_T;
...
FID_TO_TYPE_ENUM  (
    ...
    FTYPE_ENUM  (
        ...
        CAPTURE_MODE_BRIGHT_MAGIC,	//qiaoxiujun,bright magic mode
        NUM_OF_CAPTURE_MODE
    )
) CAPTURE_MODE_T;
