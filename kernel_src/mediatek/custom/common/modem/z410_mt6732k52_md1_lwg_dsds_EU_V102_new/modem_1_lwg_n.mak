...
# Generated at 2014-09-04 12:09:40
...
# ------------------------------ Verno information
VERNO = MOLY.LR9.W1423.MD.LWTG.MP.V1.P36
BUILD = BUILD_NO
...
PROJECT_MAKEFILE_EXT = SIMCOM6752_LWT_KK_MD1(LWG)_EXT
#
#  Copyright Statement:
#  ---------------------------
#  This software/firmware and related documentation ("MediaTek Software") are
...
#[MTK internal used]# ------------------------------ 
ORIGINAL_VERNO = MOLY.LR9.W1423.MD.LWTG.MP.V1.P36
DSP_IMG_ON_EMI = TRUE
  # Description:
...
HW_VER = SIMCOM6752_LWT_KK_MD1_HW
...
ORIGINAL_PROJECT_NAME = SIMCOM6752_LWT_KK_MD1
...
#yangyang 20141128 remove
#CUSTOM_OPTION += __EXTEND_SML_KEY_LEN__
...
CUSTOM_OPTION += __SIM_HOT_SWAP_POLL_TIMER__
# ************************************************************************* 
...
#yangyang 20140927 added
include make/custom_config/simcom_config.mak
