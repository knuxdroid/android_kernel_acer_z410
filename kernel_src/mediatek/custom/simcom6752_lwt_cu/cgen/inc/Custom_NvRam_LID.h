...
typedef enum
{
    ...
    AP_CFG_REEB_PRODUCT_INFO_LID,        //59
...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_RDCL_FILE_AUDIO_MAGI_CONFERENCE_LID, //70
	#ifdef GSENSOR_CALI_BACKUP_TO_PRO_INFO
//pei_add_start	
    AP_CFG_RDCL_HWMON_BACKUP_LID,// 71
//pei_add_end	
	#endif
...
#ifdef GSENSOR_CALI_BACKUP_TO_PRO_INFO
#define AP_CFG_RDCL_HWMON_BACKUP_LID_VERNO      "000"  //pei_add
#endif
