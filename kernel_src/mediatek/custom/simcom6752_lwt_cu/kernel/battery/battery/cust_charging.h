...
//#define MTK_TEMPERATURE_RECHARGE_SUPPORT //LK@mask,default open in code
...
#if defined(ACER_Z410)
#define CHARGING_FULL_CURRENT    260	//mA
#else
...
#define BATTERY_NOTIFY_CASE_0002_VBATTEMP_HIGH
...
#define BATTERY_NOTIFY_CASE_0006_VBATTEMP_LOW
