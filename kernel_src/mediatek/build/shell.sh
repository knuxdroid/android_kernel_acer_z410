...
function copy_to_legacy_download_folder() {
  echo "*** copy_to_legacy_download_folder() 2"    
  for item in $@; do
    echo "*** copy_to_legacy_download_folder() 2000000 $item $legacy_download_path"    
    if [ -e $item ]; then
      chmod u+w $item
      echo "*** copy_to_legacy_download_folder() 2 item $item"  
      echo "*** copy_to_legacy_download_folder() 2 legacy_download_path $legacy_download_path"      
