...
onHandleStartPreview()
{
    ...
    if( mpParamsMgr->getShotMode() == eShotMode_BrightMagicShot 
		&& (0 == strcmp(mpParamsMgr->getStr(MtkCameraParameters::KEY_BINING_MODE), "on")))	//qiaoxiujun,bining mode
    {
    	sensorScenario = SENSOR_SCENARIO_ID_CUSTOM1;
        //
        configInfo.rollbackBufNum = 0;
