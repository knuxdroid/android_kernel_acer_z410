...
MRESULT AeMgr::setSceneMode(MUINT32 u4NewAEScene)
{
    ...
    switch(eNewAEScene) {
        ...
        case MTK_CONTROL_SCENE_MODE_CANDLELIGHT:
            ...
            break;
        case MTK_CONTROL_SCENE_MODE_BACKLIGHT:	//acer camera 3.2
            eAEScene = LIB3A_AE_SCENE_BACKLIGHT;
            break;
        case MTK_CONTROL_SCENE_MODE_BACKLIGHT_PORTRAIT:
            eAEScene = LIB3A_AE_SCENE_BACKLIGHT_PORTRAIT;
            break;
        default:
