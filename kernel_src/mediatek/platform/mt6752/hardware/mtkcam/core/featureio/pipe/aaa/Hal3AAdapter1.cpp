...
setParams(Param_T const &rNewParam)
{
    ...
    case NSFeature::SCENE_MODE_BARCODE:
        ...
        break;
	case NSFeature::SCENE_MODE_BACKLIGHT:	//acer camera 3.2	
        rParamConvert.u4SceneMode = MTK_CONTROL_SCENE_MODE_BACKLIGHT;
        break;
	case NSFeature::SCENE_MODE_BACKLIGHT_PORTRAIT:
        rParamConvert.u4SceneMode = MTK_CONTROL_SCENE_MODE_BACKLIGHT_PORTRAIT;
        break;
    }
