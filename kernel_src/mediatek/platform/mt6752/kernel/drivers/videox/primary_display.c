...
void disp_set_sodi(unsigned int enable, unsigned int use_cmdq)
{
    ...
    {        
        ...
        {
            if(enable==1)
                cmdqRecWrite(pgc->cmdq_handle_config, DISP_REG_SODI_PA, 0, 1);
            else
                cmdqRecWrite(pgc->cmdq_handle_config, DISP_REG_SODI_PA, 1, 1);
        }
        else
        {
            if(enable==1)
