...
{ 
	CHARGE_CURRENT_675_00_MA , CHARGE_CURRENT_800_00_MA ,CHARGE_CURRENT_900_00_MA , CHARGE_CURRENT_1050_00_MA,CHARGE_CURRENT_1150_00_MA ,CHARGE_CURRENT_1275_00_MA, CHARGE_CURRENT_1400_00_MA, CHARGE_CURRENT_1525_00_MA 
}; 
#else
/*isense: 68 mO*/
const kal_uint32 CS_VTH[]=
...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	#if defined(ACER_JADE)
            bq24158_config_interface_liao(0x06,0x58); //56mo: ISAFE = 1299mA(CC=1175mA), VSAFE = 4.36V(CV=4.34)
	#else
...
//#if defined(CONFIG_POWER_EXT)
    ...
    if(g_charger_type!=CHARGER_UNKNOWN && g_charger_type!=WIRELESS_CHARGER)
    {
        *(CHARGER_TYPE*)(data) = g_charger_type;
        battery_xlog_printk(BAT_LOG_CRTI, "bq14158 CHARGER return %d!\r\n", g_charger_type);
        return status;
    }
