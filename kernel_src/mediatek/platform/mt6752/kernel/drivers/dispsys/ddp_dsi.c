...
#if defined(ACER_JADEE)
		//LCM lane1 connect to CPU lane2,config PHY1 as lane2
		MIPITX_OUTREGBIT(MIPITX_DSI_PHY_SEL_REG,DSI_PHY_REG[i]->MIPITX_DSI_PHY_SEL,MIPI_TX_PHY1_SEL,0);

		//LCM lane0 connect to CPU lane1,config PHY0 as lane1
		MIPITX_OUTREGBIT(MIPITX_DSI_PHY_SEL_REG,DSI_PHY_REG[i]->MIPITX_DSI_PHY_SEL,MIPI_TX_PHY0_SEL,2);

		//LCM lane2 connect to CPU lane0,config PHY2 as lane0
		MIPITX_OUTREGBIT(MIPITX_DSI_PHY_SEL_REG,DSI_PHY_REG[i]->MIPITX_DSI_PHY_SEL,MIPI_TX_PHY2_SEL,1);

		//RX should connect to LCM lane0,config to CPU PHY0 lane1
		MIPITX_OUTREGBIT(MIPITX_DSI_PHY_SEL_REG,DSI_PHY_REG[i]->MIPITX_DSI_PHY_SEL,MIPI_TX_LPRX_SEL,1);
#endif
