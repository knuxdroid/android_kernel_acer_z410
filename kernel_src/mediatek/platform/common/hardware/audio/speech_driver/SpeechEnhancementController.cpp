...
//default off on magic conference function for jadeS
#if 0 //defined(ACER_JADEL)
    property_get(PROPERTY_KEY_MAGIC_CON_CALL_ON, magic_conference_call_on, "1"); //"1": default on
#else
