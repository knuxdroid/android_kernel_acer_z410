...
CUSTOM_HAL_IMGSENSOR =gc5004_mipi_raw ov5670_mipi_raw gc2355_mipi_raw ov2680_mipi_raw gc0310_mipi_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR=gc5004_mipi_raw ov5670_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR=gc5004_mipi_raw ov5670_mipi_raw gc2355_mipi_raw ov2680_mipi_raw gc0310_mipi_yuv 
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=gc5004_mipi_raw ov5670_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR=gc2355_mipi_raw ov2680_mipi_raw gc0310_mipi_yuv
...
CUSTOM_LK_LCM=sim_rm68191_qhd_dsi_vdo_cmi_45 sim_otm9605_qhd_dsi_vdo_hsd_45
...
RESOURCE_OVERLAY_SUPPORT=generic navbar
SIM_ME_LOCK_MODE=0
...
CUSTOM_MODEM=z410_mt6732k52_md1_lwg_dsds_EU_V102_new
...
CUSTOM_KERNEL_LCM=sim_rm68191_qhd_dsi_vdo_cmi_45 sim_otm9605_qhd_dsi_vdo_hsd_45
...
MTK_PRODUCT_LOCALES=en_GB en_US da_DK fi_FI nb_NO es_ES pt_BR fr_FR de_DE it_IT pt_PT nl_NL sv_SE tr_TR
...
#CREATE_PROJECT_INFO=2014090321496
MTK_BUILD_VERNO = Acer_AV0K0_Z410_1.015.00_EMEA_GEN1

SIMCOM_ACER_MODEM_VER_STRING=MOLY.LR9.W1423.MD.LWTG.MP.V1.P36

#config oobe default country
SIMCOM_ACER_OOBE_COUNTRY=GBR

PREOJECT_NAME = ACER_Z410
CUSTOM_NAME =  
#WENTAO ADD
SIMCOM_QUICKTOUCH_SUPPORT = yes
SIMCOM_BUILD_LAST_SVN_LABEL=3577
#zhangjie add for bootanimation
SIMCOM_COMMON_BOOTANIMATION=yes
SIMCOM_ACER_NIDUS=yes
SIMCOM_ACER_THEME=yes
SIMCOM_ACER_LIQUID=yes
SIMCOM_ACER_FLOATAPP=yes


SIMCOM_ACER_PRODUCT_MODEL=Z410
SIMCOM_ACER_PRODUCT_BOARD=samba
SIMCOM_ACER_PRODUCT_BRAND=acer
SIMCOM_ACER_PRODUCT_NAME=z410_emea_gen1
SIMCOM_ACER_PRODUCT_DEVICE=acer_z410
SIMCOM_ACER_BUILD_PRODUCT=acer_z410
SIMCOM_ACER_PRODUCT_NANUFACTURER=Acer
SIMCOM_ACER_GOOGLE_CLIENTIDBASE=android-acer
SIMCOM_ACER_PRODUCT_MODELALIAS=Z410
SIMCOM_ACER_BUILD_SKU=EMEA_GEN1
SIMCOM_ACER_HARDWARE_VERSION=2BT041_V1.03_PCB
SIMCOM_ACER_BUILD_PANDORA_ID=Acer_AV0K0_Z410_RV01RC15_EMEA_GEN1
#add by NavyGUo for Task manager
SIMCOM_TASK_MANAGER_SUPPORT = no

#add by wangying for flash light 2014-09-03
MMI_FLASH_LIGHT = yes

#pei_add 2014-09-11
GSENSOR_CALI_BACKUP_TO_PRO_INFO = yes
SUPPORT_PS_CALI = yes

#punk
ACER_COMMON_DRV = yes
ACER_RUNIN_CHARGING = yes

#qiaoxiujun,for arcsoft
ARCSOFT_CAMERA_FEATURE = no

#add by wentao for quick guide
SIMCOM_QUICKGUIDE_SUPPORT = yes
